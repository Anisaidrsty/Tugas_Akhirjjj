Feature: API Testing for DummyAPI.io
  ...
  Scenario: Create a new user
    Given I have user details with first name "Anisa", last name "indriani", and a unique email
  ...
  Scenario: Update user details
    Given I have the saved user ID
    And I have updated user details with name "Annisa" and email "annisa@example.com"
